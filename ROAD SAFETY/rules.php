      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
            <center>
            <h2 style="color:#FFF">Add Rules</h2>
            <form action="ruleaction.php" method="post" enctype="multipart/form-data">
            <table style="color:#F00">
            <tr><td>Rule</td><td><input type="text" name="t1" required="yes"></td></tr>
            <tr><td>&nbsp;</td></tr>
            <tr><td>Deatils</td><td><textarea name="t2" id="t2" required="yes"></textarea></td></tr>
            <tr><td>&nbsp;</td></tr>
            <tr><td>Fine</td><td><input type="text" name="t3" required="yes"></td></tr>
            <tr><td>&nbsp;</td></tr>
            <tr><td>Document</td><td><input type="file" name="file" required="yes"></td></tr>
           <tr><td>&nbsp;</td></tr>
