...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right justify-content-end">
						    <p class="mb-0 register-link"><a href="ureg.php" class="mr-3">Sign Up</a><a href="login.php">Sign In</a></p>
					    </div>
				    </div>
			    </div>
		    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	  ...
	  <section class="hero-wrap js-fullheight" style="background-image:url(images/i.jpg);" data-section="home" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
            <center>
            <h2 style="color:#FFF">USER REGISTRATION DETAILS</h2>
            <form action="uregaction.php" onSubmit="return check();">
            <table style="color:#000">
            <tr><td>Name</td><td ><input type="text" name="t1" required="yes" id="t1"></td></tr>
           
            <tr><td>Address</td><td><textarea name="t2"></textarea></td></tr>
          
            <tr><td>Contact Number</td><td><input type="text" id="t3" name="t3" maxlength="10" minlength="10" required="yes"></td></tr>
          
            <tr><td>Email</td><td><input type="email" name="t4"></td></tr>
           
               <tr><td>Vehicle No</td><td><input type="text" name="t6"></td></tr>
           
            <tr><td>Password</td><td><input type="password" name="t5" required="yes"></td></tr>
            <tr><td>&nbsp;</td></tr>
            <tr><td align="center" colspan="2"><input type="submit" value="REGISTER" class="btn-danger"></td></tr>
                        </table>
            </form>
            </center>
             </div>
