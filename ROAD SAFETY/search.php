    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
         ...
         <tr><td>Spot</td><td><input type="text" name="t1" required="yes"></td><td><input type="submit" value="Search" class="btn-danger"></td></tr>
           </table>
           </form>
           <?php
		   ...
		   if(!empty($_POST['t1']))
{
  ...
  //$b=$_POST['t2'];
  //$c=$_POST['t3'];
  $q="select * from accident where spot='$a'";
  $rt=$db->selectQuery($q);
  if($rt==1)
  {
