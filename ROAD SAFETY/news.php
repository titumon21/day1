      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
            <center>
            <h2 style="color:#FFF">NEWS DETAILS</h2>
            <form action="newsaction.php">
            <table style="color:#F00">
            <tr><td>Title</td><td><input type="text" name="t1" required="yes"></td></tr>
            <tr><td>&nbsp;</td></tr>
            <tr><td>Description</td><td><textarea name="t2" required="yes"></textarea></td></tr>
            <tr><td>&nbsp;</td></tr>
