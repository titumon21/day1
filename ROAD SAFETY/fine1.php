      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
            <center>
            <h2 style="color:#FFF">FINE DETAILS</h2>
            <form action="fineaction.php">
            <table style="color:#F00">
            <?php
			include'DatabaseCon.php';
			$db=new DatabaseCon;
			$id=$_GET['id'];
			$q="select * from ureg where rid='$id'";
			$rs=$db->selectData($q);
			while($row=mysql_fetch_array($rs))
			{
				?>
                <tr><td><input type="hidden" name="t" value="<?php echo $row['rid'];?>" readonly></td></tr>
            <tr><td>Vehicle No</td><td><input type="text" name="t1" value="<?php echo $row['vhno'];?>" readonly></td></tr>
            <tr><td>&nbsp;</td></tr>
            <tr><td>Fine Amount</td><td><input type="text" name="t2" required="yes"></td></tr>
            <tr><td>&nbsp;</td></tr>
            <tr><td>Date</td><td><input type="text" name="t3" value="<?php echo date('m-d-Y');?>" readonly></td></tr>
            <?php
			}
			?>
            <tr><td>&nbsp;</td></tr>
